...
#define DBUS_TEST_EXEC "/usr/src/dbus/dbus/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/usr/src/dbus/dbus/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.7.2"
...
/* Full path to the daemon in the builddir */
#define TEST_BUS_BINARY "/usr/src/dbus/dbus/bus/dbus-daemon"
